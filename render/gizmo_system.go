...
// run BEFORE [UpdatePanOrbitCamera] in the engine schedule so the
// camera controller can read [Gizmos.Dragging] / [Gizmos.HoverAxis]
...
func AddGizmoPass(renderer *Renderer, colorID ResourceID) (*Pass, error) {
